...
import com.meituan.ptubes.reader.producer.mysqlreplicator.common.error.ExceedLimitException;
...
import com.meituan.ptubes.reader.producer.mysqlreplicator.utils.json.JsonBinary;
...
public class XInputStreamImpl extends InputStream implements XInputStream {
	...
	@Override
	public StringColumn readFixedLengthJsonString(final int length) throws IOException {
		byte[] byteArr = readBytes(length);
		return StringColumn.valueOf(JsonBinary.parseAsString(byteArr).getBytes());
	}
