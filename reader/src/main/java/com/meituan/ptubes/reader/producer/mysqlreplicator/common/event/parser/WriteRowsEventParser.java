...
import com.meituan.ptubes.reader.producer.mysqlreplicator.common.event.WriteRowsEvent;
...
public class WriteRowsEventParser extends AbstractRowEventParser {
	...
	protected List<Row> parseRows(XInputStream is, TableMapEvent tme, WriteRowsEvent wre) throws IOException {
